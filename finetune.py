...
model = Model_tune(args).to(args.device)
...
def train():
    ...
    for epoch in range(args.epochs):
        ...
        torch.save(model.state_dict(), args.dataset+args.resume.split('/')[4]+'finetune_epoch={}.pth'.format(epoch))
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load(args.dataset+args.resume.split('/')[4]+'finetune_epoch={}.pth'.format(best_model)))
